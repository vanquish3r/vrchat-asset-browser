document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('vrchat_assets.json')
        ...
        .catch(error => {
            ...
            itemContainer.innerHTML = '<p style="color: red; text-align: center;">Failed to load assets. Please check the console for errors.</p>';
        });
    ...
    function populateFilters() {
        ...
        const sortedSub = [...subCategories].sort();
            ...
            card.innerHTML = `
                <div class="card-header">
                    ...
                    <div class="card-categories">
                        ...
                        <span class="card-badge">${item.subCategory}</span>
                    </div>
                </div>
    ...
    subcategoryFilter.addEventListener('change', renderItems);
